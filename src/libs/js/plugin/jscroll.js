    ...
    $.fn.extend({ //添加滚轮事件//by jun
        mousewheel: function(Func) {
            return this.each(function() {
                var _self = this;
                _self.D = 0; //滚动方向
                if (/msie/.test(navigator.userAgent.toLowerCase()) || /safari/.test(navigator.userAgent.toLowerCase())) {
        ...
        jscroll: function(j) {
            return this.each(function() {
                ...
                if (j.Bar.offset == 0) {
                    ...
                    j.Bar.offset = j.Bar.offset || jun.Bar.offset;
                };
                ...
                jscrollh.off().on("mousedown.scroll", function(e) {
                ...
                jscrollu.off().on("mousedown.scroll", function(e) {
                    j['Fn'] && j['Fn'].call(_self);
                    Isup = 1;
                    jscrollu.css({
                ...
                jscrolld.off().on("mousedown.scroll", function(e) {
                    j['Fn'] && j['Fn'].call(_self);
                    Isup = 1;
                    jscrolld.css({
                ...
                jscrolle.off().on("mousedown.scroll", function(e) {
                    j['Fn'] && j['Fn'].call(_self);
                ...
                $(_self).off().on('mousewheel', function() {
